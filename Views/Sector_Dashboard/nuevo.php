    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="<?= base_url ?>/Sector_Dashboard"><?= $data["page_principal"]; ?></a></li>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="card">
            ...
            <a class="btn btn-success" href="<?= base_url ?>/Sector_Dashboard"  role="button" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Volver" title="volver"><?= SITE_ICON_REPLY ?></a>
              ...
              <h5 class="card-title">Crear nuevo sector:</h5>
              <!-- General Form Elements -->
              <form action="<?= base_url ?>/Sector_Dashboard/store" method="POST" class="needs-validation" novalidate>
                <div class="card-body">
